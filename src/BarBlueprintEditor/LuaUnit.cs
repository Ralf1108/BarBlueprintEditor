...
public record UnitDefinition(string Name, LuaUnit Unit);
...
public class Customparams
{
    ...
    public int Buildinggrounddecaldecayspeed { get; set; }

    [JsonPropertyName("buildinggrounddecalsizex")]
    public int Buildinggrounddecalsizex { get; set; }

    [JsonPropertyName("buildinggrounddecalsizey")]
    public int Buildinggrounddecalsizey { get; set; }
